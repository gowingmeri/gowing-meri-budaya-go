...
"use client"; // Pastikan ada ini karena kita menggunakan useState (Hooks)

import React, { useState } from 'react';
import { Eye, EyeOff, X } from 'lucide-react';
import Link from 'next/link'; // Menggunakan Link dari Next.js untuk navigasi yang benar
...
const LoginPage = () => {
  ...
  // PERBAIKAN: Menambahkan tipe data (e: React.FormEvent)
        ...
        <div className="bg-white rounded-xl">
          ...
          <div className="p-5">
            <div className="flex items-center justify-center">
              <h1 className="text-2xl justify-center font-semibold text-gray-900">Login or Signup</h1>
            </div>
          </div>

          {/* Form Content */}
          <div className="p-6">
            {/* PERBAIKAN: Menggunakan <form> dan onSubmit.
               Ini memungkinkan user menekan 'Enter' untuk submit.
            */}
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Tombol Login Utama */}
              {/* PERBAIKAN: type="submit" dan hapus onClick (karena sudah di handle oleh form onSubmit) */}
              <button 
                type="submit"
                className="w-full p-3 bg-primary text-white rounded-xl font-medium shadow-sm hover:bg-primarytransition-all duration-200"
              >
                Log in
              </button>
            </form>
