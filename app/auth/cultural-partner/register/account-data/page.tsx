...
const CulturalPartnerRegisterAccountDataPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push("/auth/cultural-partner/register/cultural-asset-verification-document");
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Nama penanggung jawab (PIC)</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Untuk login & verifikasi</p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Nomor WhatsApp</p>
              </div>
...
export default CulturalPartnerRegisterAccountDataPage;
